...
import com.gb.parkinglot.service.ParkingFloor;
import com.gb.parkinglot.service.ParkingLot;
import com.gb.parkinglot.service.gates.EntrancePanel;
import com.gb.parkinglot.service.gates.ExitPanel;
import com.gb.parkinglot.service.parkingspot.CarParkingSpot;
import com.gb.parkinglot.service.parkingspot.MotorBikeParkingSpot;
...
public class ParkinglotApplication {
    public static void main(String[] args) throws InvlaidParkingFloorException {
        ...
        /**
         * Adding entrance and exit panel
         */
        ...
        //Admin Case 3 - should be able to add entrance panel
        EntrancePanel entrancePanel1 = new EntrancePanel("2");
        ((Admin) adminAccount).addEntrancePanel(entrancePanel1);

        //Admin Case 4 - should be able to add exit panel
        ExitPanel exitPanel1 = new ExitPanel("2");
        ((Admin) adminAccount).addExitPanel(exitPanel1);
